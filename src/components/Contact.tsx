    ...
    <section id="contact" className="bg-black">
      <div className="container mx-auto pt-12 pb-48">
        <div className="pt-28 mx-auto text-left">
          <h1 className="text-my-white font-tasa font-bold text-9xl tracking-wider">
            Let's Talk !
          </h1>
        </div>
        <div className="container grid grid-cols-2 gap-10 pt-20">
          <div>
            ...
            <p className="text-my-white font-tasa font-black text-4xl py-5 hover:scale-[1.03] hover:text-faye duration-200">
